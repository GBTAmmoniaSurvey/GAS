...
L1688 = {'scalebar_size': 0.1*u.pc, 'scalebar_pos': 'bottom right',
         'distance' : 137.3*u.pc,
         'rms_range' : [0.05,1.0], 'rms_bin' : 0.01,
         'beam_pos' : 'bottom left',
...
L1689 = {'scalebar_size': 0.1*u.pc, 'scalebar_pos': 'top right',
         'label_loc' : [0.025,0.95], 'label_ha' : 'left',
         'rms_range' : [0.05,0.8], 'rms_bin' : 0.01,
         'beam_pos' : 'bottom left',
         'distance' : 137.3*u.pc,
         'sigma_mult' : 1.
         }

L1712 = {'scalebar_size': 0.1*u.pc, 'scalebar_pos': 'bottom right',
         'distance' : 137.3*u.pc,
         'rms_range' : [0.05,0.6], 'rms_bin' : 0.01,
         'beam_pos' : 'bottom left',
         'label_loc' : [0.025,0.95], 'label_ha' : 'left',
         'sigma_mult' : 1.
         }
...
L1451 = {'scalebar_size': 0.1*u.pc, 'scalebar_pos': 'bottom right',
         'distance' : 250.*u.pc,
         'rms_range' : [0.05,0.6], 'rms_bin' : 0.01,
         'beam_pos' : 'bottom left',
         'label_loc' : [0.025,0.95], 'label_ha' : 'left',
...
L1448 = {'scalebar_size': 0.1*u.pc, 'scalebar_pos': 'bottom right',
         'distance' : 250.*u.pc,
         'rms_range' : [0.05,0.6], 'rms_bin' : 0.01,
         'beam_pos' : 'bottom left',
         'label_loc' : [0.025,0.95], 'label_ha' : 'left',
...
CrAeast = {'scalebar_size': 0.1*u.pc, 'scalebar_pos': 'bottom right',
           'distance' : 130.*u.pc,
           'rms_range' : [0.05,1.6], 'rms_bin' : 0.04,
           'beam_pos' : 'bottom left',
           'label_loc' : [0.025,0.95], 'label_ha' : 'left',
           'sigma_mult' : 1.
         }

# Gobelins distance 138.6 pc
...
plottingDictionary = {"L1688" : L1688, "B18" : B18, "NGC1333" : NGC1333, 
                      ...
                      "L1448" : L1448, "L1451" : L1451, "L1455" : L1455,
                      "HC2" : HC2, "Pipe_Core40" : Pipe_Core40, "Perseus" : Perseus,
                      "L1689" : L1689, "L1712" : L1712, 
